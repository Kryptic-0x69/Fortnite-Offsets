...
uintptr_t LOCAL_PAWN = 0x350;
uintptr_t PAWN_PRIVATE = 0x320;
uintptr_t ROOT_COMPONENT = 0x1B0;
uintptr_t PLAYER_STATE = 0x2C8;
...
uintptr_t WEAPON_NAME = 0x40;
uintptr_t PERSISTENT_LEVEL = 0x40;
uintptr_t ISDYING = 0x718;
uintptr_t GlobalAnimRateScale = 0xA20;
uintptr_t bADSWhileNotOnGround = 0x5869;
